...
@Component({
  selector: 'app-date-selector2',
  templateUrl: './date-selector2.component.html',
  styleUrls: ['./date-selector2.component.scss'],
    imports: [
    CommonModule, 
    FormsModule, 
    MatDatepickerModule, 
...
export class DateSelector2Component  implements OnInit {
