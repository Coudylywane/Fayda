...
import { parsePhoneNumberWithError, formatNumber, AsYouType, CountryCode } from 'libphonenumber-js';
import { COUNTRIES } from '../../utils/countries';

/**
 * Composant d'entrée de numéro de téléphone avec sélection de pays et formatage automatique.
 * Utilise libphonenumber-js pour le formatage et la validation.
 */
@Component({
